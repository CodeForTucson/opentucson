...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Crime.howreceive'
        db.add_column(u'crime_crime', 'howreceive',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Crime.howreceivee'
        raise RuntimeError("Cannot reverse this migration. 'Crime.howreceivee' and its values cannot be restored.")
